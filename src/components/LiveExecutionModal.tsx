      ...
      <div className={`relative w-full ${isHistoryExpanded ? 'max-w-6xl' : 'max-w-3xl'} bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 flex flex-col max-h-[95vh] overflow-hidden transition-all duration-200`}>
        ...
        <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
          ...
          <div className="flex-1 flex flex-col overflow-hidden bg-white dark:bg-slate-900">
            {/* Decoupled Fixed Company Header Card (Eliminates Sticky Bleed) */}
            <div className="border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 px-5 py-3 shrink-0">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="truncate mt-0.5">
                          {companyMainPhone ? (
                            ...
                            <span className="text-xs text-slate-400 font-medium">No Switchboard Listed</span>
                          )}
                        </div>
                      </div>
